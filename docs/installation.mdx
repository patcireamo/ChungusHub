...
a Tailscale name or a domain you point at it through a proxy, add that name to this list. Any
name that is not on it is turned away with a page telling you what to add, which is what keeps a
site you visit from reaching your workspace by pointing its own address at your computer.
